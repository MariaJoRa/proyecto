	...
	public static void main(String[] args) {
		...
		ArrayList<String> contrincantes= new ArrayList<String>();
				...
				case 2:
					...
					int[] puntajeFinal= {puntosAlemaniaSimulacion, puntosArgentinaSimulacion, puntosInglaterraSimulacion, puntosBrasilSimulacion,
							puntosItaliaSimulacion, puntosFranciaSimulacion};
					Arrays.sort(puntajeFinal);
					
					JOptionPane.showMessageDialog(null, "A continuación se muestran los puntajes en orden de menor a mayor ");
